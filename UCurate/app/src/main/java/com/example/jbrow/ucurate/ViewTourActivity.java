...
public class ViewTourActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Todo - this should orient the camera to the user's actual current location
        LatLng cp = new LatLng(38.984929, -76.947760);
        mMap.moveCamera(CameraUpdateFactory.newLatLng(cp));
        mMap.moveCamera(CameraUpdateFactory.zoomTo( 15.0f ));

        LatLng start = null;
        for (Artwork art:artworks) {
            mMap.addMarker(new MarkerOptions().position(art.location).title(art.title).snippet(art.description));
